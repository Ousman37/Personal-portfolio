...
//             }}
//           >
//             <Image src="/ousman.png" alt='Portrait of Ethmane' width="192" height="192"
//               quality="95" objectFit='cover' priority={true}
//               className="h-24 w-24 rounded-full object-cover border-[0.1rem] border-white shadow-xl" />
//           </motion.div>
...
//         </div>
//       </div>
//       <motion.h1 className='mb-10 mt-4 font-bold font-md text-transparent bg-clip-text bg-gradient-to-tr from-blue-500 to-pink-600'><TypewriterComponent /></motion.h1>
//       <motion.p className='mb-10 mt-4 px-4 text-[1.2rem] font-medium !leading-[1.5] sm:4-xl'
//        initial={{ opacity: 0, y: 100}}
//        animate={{ opacity: 1, y: 0}}
//       >
//         As a <span className='text-blue-500'>Front end developer,</span> I bring a passionate approach to web development, crafting innovative solutions, and transforming ideas into tangible code. I invite you to dive into my <span className='underline'>portfolio</span> and explore the vibrant projects that have shaped my journey through an intensive year of learning and building. Each piece tells a unique story of challenges met, skills honed, and creativity unleashed. Enjoy exploring, and <span className='italic'>let&apos;s connect!</span>
//       </motion.p>
//       <motion.div
//   className="flex flex-col sm:flex-row items-center justify-center gap-2 px-4 text-lg font-medium mt-8"
//   initial={{ opacity: 0, y: 100 }}
...
//     target="_blank"
//     rel="noopener noreferrer"
//     className="bg-gray-200 hover:bg-gray-300 text-gray-800 px-7 py-3 flex items-center gap-2 rounded-full transition focus:scale-110 hover:scale-110 cursor-pointer border border-black/5"
//   >
//     Download CV{' '}
//     <HiDownload className="ml-2 opacity-60 group-hover:translate-y-1 transition" />
//   </a>
