    ...
    <html lang="en" className='!scroll-smooth'>
     <body
      ...
      >
        ...
        <div className="bg-[#d0f0c0] absolute top-[-6rem] -z-10 right-[11rem] h-[31.25rem] w-[31.25rem] rounded-full blur-[10rem] sm:w-[68.75rem] dark:bg-[#749475] dark:bg-[#946263"></div>
